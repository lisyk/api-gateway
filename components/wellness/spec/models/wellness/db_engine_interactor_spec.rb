      ...
      context 'call' do
        ...
        describe 'record exists' do
          ...
          it 'updates existing record' do
            expect(DbEngineInteractor.call(pet_id: uuid, contract_app_id: '2346')).to eq 'record updated'
          end
        end
        describe 'record does not exist' do
          ...
          it 'create new record' do
            expect(DbEngineInteractor.call(pet_id: uuid, contract_app_id: '2346')).to eq 'record created'
          end
        end
      end
    end
